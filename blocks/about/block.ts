...
export const aboutBlock = defineBlock({
  ...
  props: {
    ...
    "heading": fields.text({ label: "Heading", defaultValue: "Building the Future of", required: true }),
    "headingHighlight": fields.text({ label: "Heading Highlight", defaultValue: "CMS" }),
    "subtitle": fields.textarea({ label: "Subtitle", defaultValue: "We're on a mission to make professional website creation accessible to everyone, powered by AI and modern technology." }),
    "missionHeading": fields.text({ label: "Mission Heading", defaultValue: "Our Mission" }),
    "missionText": fields.textarea({ label: "Mission Text", defaultValue: "We believe that creating beautiful, professional websites shouldn't require a team of developers or expensive agencies. Cmssy empowers creators, businesses, and developers to build stunning websites with AI-powered tools, intuitive drag-and-drop editing, and enterprise-grade performance." }),
    "valuesHeading": fields.text({ label: "Values Heading", defaultValue: "Our Values" }),
    ...
    "techStackHeading": fields.text({ label: "Tech Stack Heading", defaultValue: "Built With Modern Tech" }),
