...
export const loginFormBlock = defineBlock({
  ...
  props: {
    ...
    "description": fields.textarea({ label: "Description", defaultValue: "Sign in to your account to continue." }),
    ...
    "passwordPlaceholder": fields.text({ label: "Password Placeholder", defaultValue: "Enter your password" }),
    "submitButtonText": fields.text({ label: "Submit Button Text", defaultValue: "Sign in" }),
    "submitLoadingText": fields.text({ label: "Submit Loading Text", defaultValue: "Signing in..." }),
    "showRememberMe": fields.boolean({ label: "Show Remember Me", defaultValue: true }),
    "rememberMeLabel": fields.text({ label: "Remember Me Label", defaultValue: "Remember me" }),
    "showForgotPassword": fields.boolean({ label: "Show Forgot Password Link", defaultValue: true }),
    "forgotPasswordText": fields.text({ label: "Forgot Password Text", defaultValue: "Forgot your password?" }),
    ...
    "registerLinkText": fields.text({ label: "Register Link Text", defaultValue: "Don't have an account? Sign up" }),
    ...
    "successMessage": fields.textarea({ label: "Success Message", defaultValue: "Login successful! Redirecting..." }),
    "errorMessage": fields.textarea({ label: "Default Error Message", defaultValue: "Invalid email or password. Please try again." }),
