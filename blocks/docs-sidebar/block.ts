...
export const docsSidebarBlock = defineBlock({
  ...
  props: {
    ...
    "sections": fields.repeater({ label: "Navigation Sections", itemSchema: {
      "title": fields.singleLine({ label: "Section Title", required: true }),
      "pages": fields.link({ label: "Pages" })
    } }),
    "showSearch": fields.boolean({ label: "Show Search", defaultValue: true }),
    "searchPlaceholder": fields.singleLine({ label: "Search Placeholder", defaultValue: "Search docs..." }),
    "showVersionSelector": fields.boolean({ label: "Show Version Selector", defaultValue: false }),
    "currentVersion": fields.singleLine({ label: "Current Version", defaultValue: "v1.0" }),
