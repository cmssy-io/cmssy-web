...
export const roadmapBlock = defineBlock({
  ...
  props: {
    ...
    "headingHighlight": fields.text({ label: "Heading Highlight", defaultValue: "Roadmap" }),
    "description": fields.textarea({ label: "Description", defaultValue: "Transparency is one of our core values. Here's what we're working on and what's coming next." }),
    ...
    "ctaTitle": fields.text({ label: "CTA Title", defaultValue: "Shape Our Roadmap" }),
    "ctaDescription": fields.textarea({ label: "CTA Description", defaultValue: "Have a feature request or idea? We'd love to hear from you." }),
    "ctaButtonText": fields.text({ label: "CTA Button Text", defaultValue: "Submit Feedback" }),
