          ...
          return (
            <div key={index} className="relative flex gap-6">
              ...
              <div className="flex flex-col items-center shrink-0">
                {/* Step circle */}
                <div className="relative z-10 flex items-center justify-center size-8 rounded-full bg-primary/10 text-primary border-2 border-primary/20 font-semibold text-sm">
                  {showNumbers ? (
                    index + 1
                  ) : (
