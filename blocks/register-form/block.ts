...
export const registerFormBlock = defineBlock({
  ...
  props: {
    ...
    confirmPasswordLabel: fields.text({
      label: "Confirm Password Label",
      defaultValue: "Confirm password",
    }),
    passwordHelpText: fields.text({
      label: "Password Help Text",
      defaultValue: "Must be at least {min} characters",
    }),
    showNameFields: fields.boolean({
    ...
    confirmPasswordPlaceholder: fields.text({
    ...
    passwordMismatchMessage: fields.text({
