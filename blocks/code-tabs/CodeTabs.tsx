...
export default function CodeTabs({
  ...
  return (
    <section id="code" className="bg-background py-24">
      <Container>
        <div className="max-w-3xl">
          <FigEyebrow fig={fig} label={eyebrow} />
          <h2 className="font-heading mt-4 text-4xl font-bold tracking-tight text-foreground text-balance">
            {heading}
          </h2>
          {description && (
            <p className="mt-3 max-w-lg text-lg text-muted-foreground">{description}</p>
          )}
        </div>
