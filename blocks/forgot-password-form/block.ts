...
export const forgotPasswordFormBlock = defineBlock({
  ...
  props: {
    "heading": fields.text({ label: "Heading", defaultValue: "Forgot your password?" }),
    "description": fields.textarea({ label: "Description", defaultValue: "Enter your email address and we'll send you a link to reset your password." }),
    ...
    "submitButtonText": fields.text({ label: "Submit Button Text", defaultValue: "Send reset link" }),
    ...
    "loginLinkText": fields.text({ label: "Login Link Text", defaultValue: "Back to login" }),
    ...
    "emailSentText": fields.text({ label: "Email Sent Text", defaultValue: "We sent an email to" }),
    "successMessage": fields.textarea({ label: "Success Message", defaultValue: "If an account exists with this email, you will receive a password reset link shortly." }),
