...
type Documents = {
    ...
    "query PublicPagesByType($workspaceId: String!, $parentSlug: String, $search: String, $limit: Int, $offset: Int) {\n  public {\n    page {\n      byType(\n        workspaceId: $workspaceId\n        parentSlug: $parentSlug\n        search: $search\n        limit: $limit\n        offset: $offset\n      ) {\n        items {\n          id\n          slug\n          fullSlug\n          publishedAt\n          displayName\n          seoTitle\n          seoDescription\n          customFields\n          pageType\n        }\n        total\n        hasMore\n      }\n    }\n  }\n}": typeof types.PublicPagesByTypeDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PublicPagesByType($workspaceId: String!, $parentSlug: String, $search: String, $limit: Int, $offset: Int) {\n  public {\n    page {\n      byType(\n        workspaceId: $workspaceId\n        parentSlug: $parentSlug\n        search: $search\n        limit: $limit\n        offset: $offset\n      ) {\n        items {\n          id\n          slug\n          fullSlug\n          publishedAt\n          displayName\n          seoTitle\n          seoDescription\n          customFields\n          pageType\n        }\n        total\n        hasMore\n      }\n    }\n  }\n}"): (typeof documents)["query PublicPagesByType($workspaceId: String!, $parentSlug: String, $search: String, $limit: Int, $offset: Int) {\n  public {\n    page {\n      byType(\n        workspaceId: $workspaceId\n        parentSlug: $parentSlug\n        search: $search\n        limit: $limit\n        offset: $offset\n      ) {\n        items {\n          id\n          slug\n          fullSlug\n          publishedAt\n          displayName\n          seoTitle\n          seoDescription\n          customFields\n          pageType\n        }\n        total\n        hasMore\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
